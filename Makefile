...
clean: ## Remove the CMake build tree, the installed artifacts and the smoke-test scratch directory
	rm -rf $(BUILD_DIR) $(SMOKE_TEST_DIR) include lib
...
test: check_build smoke_test ## Verify the generated code is complete and that the CMake package is consumable
