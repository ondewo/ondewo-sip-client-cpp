...
| `test_typed_api.cc` | **yes** | Assertions against concrete `ondewo::sip` C++ types |
...
- A plain proto3 scalar keeps its zero value off the wire and puts a non-zero one on it.
