...
| ------------------------------------------- | ---------------------------------------------------------------------- |
| a message, a field or an RPC                | [ondewo-sip-api](https://github.com/ondewo/ondewo-sip-api)                     |
...
(`ONDEWO_SIP_API_GIT_BRANCH`, `ONDEWO_PROTO_COMPILER_GIT_BRANCH`) and regenerating.
